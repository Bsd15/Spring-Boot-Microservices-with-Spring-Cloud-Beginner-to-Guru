...
import guru.sfg.beer.order.service.sm.action.BeerOrderValidateAction;
...
public class BeerOrderStateMachineConfig extends StateMachineConfigurerAdapter<BeerOrderStatusEnum, BeerOrderEventEnum> {
    ...
    private final Action<BeerOrderStatusEnum, BeerOrderEventEnum> beerOrderValidateAction;
